...
const createCategory = (category) => {
    ...
    return new Promise((resolve, reject) => {
        db_1.default.query(categoryQueries_1.CategoryQueries.CREATE_CATEGORY, [name, image], err => {
            if (err) {
...
const getAllCategories = () => {
    return new Promise((resolve, reject) => {
        db_1.default.query(categoryQueries_1.CategoryQueries.GET_ALL_CATEGORIES, (err, results) => {
            if (err) {
...
const getCategoryById = (id) => {
    return new Promise((resolve, reject) => {
        db_1.default.query(categoryQueries_1.CategoryQueries.GET_CATEGORY_BY_ID, [id], (err, results) => {
            if (err) {
...
const updateCategory = (id, categoryUpdates) => {
    ...
    return new Promise((resolve, reject) => {
        db_1.default.query(categoryQueries_1.CategoryQueries.UPDATE_CATEGORY, [name, image, id], (err, results) => {
            if (err) {
...
const deleteCategory = (id) => {
    return new Promise((resolve, reject) => {
        db_1.default.query(categoryQueries_1.CategoryQueries.GET_CATEGORY_BY_ID, [id], (err, results) => {
            ...
            db_1.default.query(categoryQueries_1.CategoryQueries.DELETE_CATEGORY, [id], deleteErr => {
                if (deleteErr) {
